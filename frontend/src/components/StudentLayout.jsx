...
import { CalendarCheck, FileText, MessageSquare, LogOut, Menu, X } from 'lucide-react'
import { useAuth } from '../context/AuthContext.jsx'
import NotificationBell from './NotificationBell.jsx'
import { getMessageUnreadCount } from '../api/index.js'
...
export default function StudentLayout() {
  ...
  useEffect(() => {
    const fetchMsg = () => getMessageUnreadCount().then(r => setMsgCount(r.data.count || 0)).catch(() => {})
    fetchMsg()
    const iv = setInterval(fetchMsg, 30000)
  ...
  const navItems = [
    ...
    { to: '/student/messages',  icon: MessageSquare, label: 'Messages', badge: msgCount },
  ]
